 ...
 */
final class Version20220519152427 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE menu ADD burgers_id INT DEFAULT NULL, ADD complements_id INT DEFAULT NULL');
