...
turbolinks.start(); // Manually configure the runtime environment if not already configured yet by the "encore" command.
...
.setPublicPath('/build') // only needed for CDN's or sub-directory deploy
...
.enableVersioning(Encore.isProduction()).configureBabel(function (config) {
